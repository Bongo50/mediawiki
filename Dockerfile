...
RUN git clone --depth 1 -b REL1_43 https://gerrit.wikimedia.org/r/mediawiki/extensions/TemplateStyles && \
    ...
    git clone --depth 1 -b v2.0.0 https://github.com/StarCitizenTools/mediawiki-extensions-Thumbro.git && mv mediawiki-extensions-Thumbro Thumbro && \
    git clone --depth 1 -b 1.7.0 https://github.com/Liquipedia/VariablesLua.git && \
